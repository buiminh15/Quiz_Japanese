...
class Login extends Component {
  ...
  render() {
    if (this.state.redirect.auto === true) {
      return (
        <Redirect to={this.state.redirect.path} search={this.state.redirect.search} state={this.state.redirect.state}></Redirect>
      )
    }
    return (
      <div className="container">
        <div className="row">
          <div className="col-8 m-auto">
            ...
            <form className="mt-4">
              <TextInputField name="email" type="email" placeholder="Email Address" onChange={this.handleChange("email")} />
              <TextInputField name="password" type="password" placeholder="Password" onChange={this.handleChange("password")} />
